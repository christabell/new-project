              ...
              @endforeach
                ...
                <div class="form-group col-md-3 mr-3">
                  ...
                  <div class="input-group date" id="datetimepicker6" data-target-input="nearest">
                    <input type="time" class="form-control datetimepicker-input"  data-target="#datetimepicker6"/>
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="input-group date" id="datetimepicker7" data-target-input="nearest">
                    <input type="time" name="end_time"class="form-control datetimepicker-input" data-target="#datetimepicker7"/>
